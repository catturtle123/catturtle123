...
| **하루멍록**<br/>(Harumeonglog)     | **2025.01 ~ 2025.12** | 반려동물 루틴 관리 및 커뮤니티 서비스<br/>비동기 알림 처리로 FCM 지연 10초 → 1초 미만 개선<br/>Redis·인덱스 최적화로 API 1983ms → 47ms 개선<br/>증분 쿼리로 좋아요·차단 카운트 동시성 해결<br/>무중단 배포 환경 구축                               | Back-End                 |
