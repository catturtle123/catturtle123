...
| 프로젝트명                           | 기간                 | 내용                                                                                                                                                                             | 역할                       |
| ------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------ |
| **IT 동아리 모음 사이트**<br/>(TECA) | **2025.04 ~ 진행 중** | 전국 대학 IT 동아리 정보 통합 플랫폼<br/>Cloudflare Workers 기반 서버리스 백엔드 설계 및 운영<br/>SEO 대응 렌더링 및 동적 메타 태그 생성 (구글 it 동아리 검색 최상위 노출)<br/>트래픽 증가 시 서버 증설 없이 대응 가능한 구조 설계<br/>월 10,000+ 요청, MAU 1,200명 달성 (2026.01 기준) | Developer                 |
